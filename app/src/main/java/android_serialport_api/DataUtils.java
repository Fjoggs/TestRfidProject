...
public class DataUtils {
    ...
    /**
     * ×Ö·ûŽ®×ª»»³ÉÊ®ÁùœøÖÆ×Ö·ûŽ®
     */
    public static String str2Hexstr(String str) {
        try {
            byte[] bytes = str.getBytes("GBK"); // žùŸÝÖž¶š±àÂë»ñÈ¡×ÖœÚÊý×é
            StringBuilder sb = new StringBuilder(bytes.length * 2); // œ«×ÖœÚÊý×éÖÐÃ¿žö×ÖœÚ²ðœâ³É2Î»16œøÖÆÕûÊý
            for (int i = 0; i < bytes.length; i++) {
    ...
    /**
     * 16œøÖÆ×Ö·ûŽ®·Öžî³ÉÈôžÉ¿é£¬Ã¿¿é32žö16œøÖÆ×Ö·û£¬ŒŽ16×ÖœÚ
     *
     * @param str
     * @return
     */
    public static String[] hexStr2StrArray(String str) {
        // 32žöÊ®ÁùœøÖÆ×Ö·ûŽ®±íÊŸ16×ÖœÚ
        int len = 32;
    ...
    /**
     * °Ñ16œøÖÆ×Ö·ûŽ®Ñ¹Ëõ³É×ÖœÚÊý×é£¬ÔÚ°Ñ×ÖœÚÊý×é×ª»»³É16œøÖÆ×Ö·ûŽ®
     *
     * @param hexstr
     * @return
     * @throws IOException
    ...
    /**
     * °Ñ16œøÖÆ×Ö·ûŽ®œâÑ¹ËõÑ¹Ëõ³É×ÖœÚÊý×é£¬ÔÚ°Ñ×ÖœÚÊý×é×ª»»³É16œøÖÆ×Ö·ûŽ®
     *
     * @param hexstr
     * @return
     * @throws IOException
